...
/** PUT /invoice/[id] - update invoice; return `{invoice: invoice}` */
...
describe("PUT /invoices/:id", function() {
  test("Updates a single invoice", async function() {
    ...
    expect(response.statusCode).toEqual(200);
    expect(response.body).toEqual({
      invoice: {id: testInvoice.id, comp_code: testInvoice.comp_code, amt: testInvoice.amt, paid: true, add_date: expect.any(String), paid_date: expect.any(String)}
    });
  });
